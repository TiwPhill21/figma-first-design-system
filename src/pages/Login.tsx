...
export function Login(){
    ...
    function handleLogin(event: FormEvent) {
        ...
        axios.post('/api/login', {
            email: 'vinivicius.testing@testing.com.br',
            password: '1234',
        })
    ...
    return (
        ...
        <form onSubmit={handleLogin} className='flex flex-col items-stretch gap-4 w-full max-w-[400px] mt-10'>
            {isUserLogged && <Text>Fununciou</Text>}
